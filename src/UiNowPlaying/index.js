...
import useStore, { fetcher, linkUrlNowPlaying } from "../store";
...
const keyPage = "pageNewPlaying";

function UiNowPlaying() {
  ...
  const {
    ...
    error,
    mutate,
  } = useSWR(linkUrlNowPlaying(page), fetcher);
