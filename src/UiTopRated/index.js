...
import useStore, { fetcher, linkUrlTopRated } from "../store";
...
function UiTopRated() {
  ...
  const {
    ...
    error,
    mutate,
  } = useSWR(linkUrlTopRated(page), fetcher);
